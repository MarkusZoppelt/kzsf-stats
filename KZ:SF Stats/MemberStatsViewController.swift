//
//  MemberStatsViewController.swift
//  KZ:SF Stats
//
//  Created by Markus Zoppelt on 23.09.14.
//  Copyright (c) 2014 Markus Zoppelt. All rights reserved.
//

import UIKit

class MemberStatsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        clanButton.addTarget(self, action: "goBackToClan:", forControlEvents: UIControlEvents.TouchUpInside)
    ...
    func goBackToClan(sender: UIButton)
    {
        navigationController?.popViewControllerAnimated(true)
    }
    ...
    func reload(sender: UIGestureRecognizer)
    {
        ...
        let stats = JSON.fromURL("http://killzone4.online.scee.com/api/profile/get-competitive/\(memberName)")
        let clanStats = JSON.fromURL("http://killzone4.online.scee.com/api/clan/get-clan-for-user/\(memberName)")
